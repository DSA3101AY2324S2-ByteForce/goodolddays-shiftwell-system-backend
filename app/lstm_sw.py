...
# Load the LSTM model
with open('../models/demand_forecast/model_architecture.json', 'r') as json_file: # architecture
    loaded_model_json = json_file.read()
model = model_from_json(loaded_model_json)
model.load_weights('../models/demand_forecast/model_weights.weights.h5') # weights
with open('../models/demand_forecast/scaler.pkl', 'rb') as scaler_file:
    loaded_scaler = pickle.load(scaler_file) # scaler

def weather_data_processing():
    data = json.load(open('../models/demand_forecast/next_7_day.json'))
